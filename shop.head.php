...
if (!empty($goods_id) && !defined('PARTNER_GOODS')) {
        define('PARTNER_GOODS', true);
}
?>
 <script>
...
<?php if(!defined('PARTNER_GOODS')) : ?>	
	...
	<header class="pc-header">
		<div class="at-container">
			...
			<div class="clearfix"></div>
                        <div id="header-banner"> <a href="http://wellup.kr/shop/partner/register.php"><img src="https://wellup.kr/img/95216fc52671487f.jpg"> </a></div>
			<div id="header-ico">
				<ul>
					<?php if(IS_YC) { //영카트 ?>
							<li class="nav-show">
		...
		<div class="at-container">
			<div class="header-wrap">
				<div class="header-icon">
					...
					<div id="header-banner-mobile"><a href="http://wellup.kr/shop/partner/register.php"><img src="https://wellup.kr/img/95216fc52671487.jpg"></a></div>
				...
				<div class="nav-right nav-rw nav-height">
					<ul>
						...
						<?php if($member['partner']) { ?>
							<li><a href="<?php echo $at_href['myshop'];?>">마이샵</a></li>
						<?php } ?>
						<li class="sidebarLabel"<?php echo ($member['response'] || $member['memo']) ? '' : ' style="display:none;"';?><?php echo get_checked($od_status, '주문'); ?>>
							<a href="javascript:;" onclick="sidebar_open('sidebar-response');"> 
								알림 <b class="orangered sidebarCount"><?php echo $member['response'] + $member['memo'] +$od['od_status'];?></b>
							</a>
						</li>
					<?php } else { // 로그아웃 상태 ?>
						<li><a href="<?php echo $at_href['login'];?>" onclick="sidebar_open('sidebar-user'); return false;">로그인</a></li>
					...
					<?php } ?>
						...
						<li><a href="http://wellup.kr/bbs/page.php?hid=company">고객센터</a></li>
					</ul>
					<div class="clearfix"></div>
				</div>
			</div>
