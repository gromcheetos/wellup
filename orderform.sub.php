    ...
    <div class="sod_left">
        ...
        <section id="sod_frm_orderer">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    <th scope="row"><label for="od_tel">전화번호<strong class="sound_only"></strong></label></th>
                    <td><input type="text" name="od_tel" value="<?php echo get_text($member['mb_tel']); ?>" id="od_tel" class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
        ...
        <section id="sod_frm_taker">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    <th scope="row"><label for="od_b_tel">전화번호<strong class="sound_only"></strong></label></th>
                    <td><input type="text" name="od_b_tel" id="od_b_tel" class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
